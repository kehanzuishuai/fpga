...
module synth_event_frontend #(
  ...
  output logic dbg_note_event,dbg_audio_onset,dbg_clip,latency_valid,
  output logic [23:0] latency_samples,output logic [5:0] mix_gain_shift,
